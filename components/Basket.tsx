  ...
  return (
    <div className="max-w-7xl mx-auto">
      <ul className="space-y-5 divide-y-2">
        {Object?.keys(grouped)?.map((sku: string) => {
          const item: Product = grouped?.[sku]?.[0];
          const total: string = getCartTotal(grouped?.[sku]);
              ...
              <div className="flex space-x-4 pl-4">
                <div>
                  ...
                  <div
                    ...
                    className="lime-clamp-1 font-light text-sm mt-2"
                  />
                </div>
      ...
      <div className="flex flex-col justify-end p-5">
        <p className="font-bold text-2xl text-right text-walmart mb-5">
          Total: {cart?.length > 0 ? basketTotal : "0"}
        </p>
